...
class ComidasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create comida" do
    assert_difference('Comida.count') do
      post comidas_url, params: { comida: { categoria: @comida.categoria, detalle: @comida.detalle, nombre: @comida.nombre, precio: @comida.precio } }
    end
  ...
  test "should update comida" do
    patch comida_url(@comida), params: { comida: { categoria: @comida.categoria, detalle: @comida.detalle, nombre: @comida.nombre, precio: @comida.precio } }
